...
export function Drawer({ open, title, onClose, children }: DrawerProps) {
  ...
  const titleId = useMemo(() => `ds-drawer-title-${Math.random().toString(36).slice(2, 10)}`, [])
  ...
  return (
    <>
      ...
      <aside ref={drawerRef} className="ds-drawer motion-modal-continuity" role="dialog" aria-modal="true" aria-labelledby={titleId} tabIndex={-1}>
